<template>
    ...
    <div v-if="isInStudentRole == true" class="nav-item px-3">
        <router-link active-class="active" class="nav-link" to="/checkin">
    ...
    <div v-if="isInTutorRole" class="nav-item px-3">
        <router-link active-class="active" class="nav-link" :to="{ name: 'RegistersPage' }">
    ...
    <div v-if="isInAdminRole" class="nav-item px-3">
