<template>
        <div v-if="isAuthenticated == true" class="align-content-end">
    ...
    <div v-else class="nav-item px-3">
    ...
    <hr/>
    <div v-if="isInStudentRole == true" class="nav-item px-3">
        <router-link active-class="active" class="nav-link" to="/student/checkin">
    ...
    <div v-if="isInTutorRole == true" class="nav-item px-3">
        <router-link active-class="active" class="nav-link" to="staff/portal">
    ...
    <div v-if="isInAdminRole == true" class="nav-item px-3">
        <router-link active-class="active" class="nav-link" to="admin/portal">
