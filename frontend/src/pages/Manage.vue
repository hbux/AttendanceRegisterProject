<template>
    <div class="d-flex justify-content-between">
        <div class="nav-item custom-item px-3">
            <router-link active-class="custom-active" class="nav-link custom-link" :to="{ name: 'RegistersPage' }">
        ...
        <div class="d-flex justify-content-center align-items-center px-3">
            <button v-if="isInModuleLeaderRole == true" type="button" class="btn btn-dark">Upload CSV</button>
        </div>
    </div>
...
export default {
    ...
    computed: {
        ...mapGetters({
            isInModuleLeaderRole: 'userModule/isInModuleLeaderRole'
        })
    },
    methods: {
